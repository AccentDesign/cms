...
SELECT id, path, level, url, page_type, title, tags, categories, featured_image, is_in_sitemap, is_searchable, search_vector, full_text, no_cache, priority, change_frequency, created_at, updated_at, published_at, meta_description, meta_og_site_name, meta_og_title, meta_og_description, meta_og_url, meta_og_type, meta_og_image, meta_og_image_secure_url, meta_og_image_width, meta_og_image_height, meta_article_publisher, meta_article_section, meta_article_tag, meta_twitter_card, meta_twitter_image, meta_twitter_site, meta_robots
FROM page
WHERE path @> $1::ltree
...
SELECT p.id, p.path, p.level, p.url, p.page_type, p.title, p.tags, p.categories, p.featured_image, p.is_in_sitemap, p.is_searchable, p.search_vector, p.full_text, p.no_cache, p.priority, p.change_frequency, p.created_at, p.updated_at, p.published_at, p.meta_description, p.meta_og_site_name, p.meta_og_title, p.meta_og_description, p.meta_og_url, p.meta_og_type, p.meta_og_image, p.meta_og_image_secure_url, p.meta_og_image_width, p.meta_og_image_height, p.meta_article_publisher, p.meta_article_section, p.meta_article_tag, p.meta_twitter_card, p.meta_twitter_image, p.meta_twitter_site, p.meta_robots, tableoid::regclass::varchar as source
FROM page p
WHERE path = $1::ltree
AND published_at <= clock_timestamp()
LIMIT 1
